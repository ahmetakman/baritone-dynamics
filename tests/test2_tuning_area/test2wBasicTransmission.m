...
sample_frequency =1e7; % baseband sample rate range = (min--> 6.52e+4,  max--> 6.133e+7)
...
%%%%%%% TRANSMITTER %%%%%%%
transmit_frequency = 3e9;

tx = sdrtx('Pluto',...
           'RadioID', 'usb:0',...
           'CenterFrequency', transmit_frequency, ...
...
t = [0:10000-1]'/sample_frequency;

s = exp(1j*2*pi*transmit_frequency*t); 
...
%scaleFactor = ((log10(sample_frequency)-6)*6+1)*sample_frequency;
